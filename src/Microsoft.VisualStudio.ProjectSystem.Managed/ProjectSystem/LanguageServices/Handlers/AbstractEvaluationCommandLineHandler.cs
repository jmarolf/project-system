...
namespace Microsoft.VisualStudio.ProjectSystem.LanguageServices.Handlers
{
    ...
    internal abstract partial class AbstractEvaluationCommandLineHandler : AbstractWorkspaceContextHandler
    {
        ...
        protected abstract void HandleItemRename(string pathBefore, string pathAfter, IProjectLogger logger);

        private void ApplyChangesToContext(IProjectChangeDiff difference,
                                           IImmutableDictionary<string, IImmutableDictionary<string, string>> metadata,
